...
impl ChatRepository {
    ...
    pub async fn insert_encrypted_message(
        ...
        let query = "INSERT INTO encrypted_messages 
                     (id, chat_id, sender_id, encrypted_content, nonce, key_fingerprint) 
                     VALUES ($1, $2, $3, $4, $5, $6)";
    ...
    pub async fn get_encrypted_messages(
        ...
        let rows = transaction.query(query, &[&chat_id])
            .await.map_err(|e| e.to_string())?;
    ...
    pub async fn get_all_chat_keys(
        ...
        let rows = transaction.query(query, &[&chat_id, &user_id])
            .await.map_err(|e| e.to_string())?;
    ...
    pub async fn store_chat_key(
        ...
        let query = "
            ...
            VALUES ($1, $2, $3)
        ";
        transaction.execute(query, &[&chat_id, &user_id, &encrypted_key]).await?;
        Ok(())
    }
    ...
    pub async fn get_chat_key(
        ...
        ";
        let row = transaction.query_opt(query, &[&chat_id, &user_id]).await?;
